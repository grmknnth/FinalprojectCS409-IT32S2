        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <Text style={{ color: COLORS.white, ...FONTS.body3 }}>150 points - ₱50 off</Text>
                    </View>
                </View>
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            ...
                            >
                                ...
                                {/* Calories */}
                                <Text style={{ marginTop: 3, color: appTheme.textColor, ...FONTS.body4 }}>Calaries: {item.calories}</Text>
