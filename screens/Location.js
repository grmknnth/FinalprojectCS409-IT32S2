...
const Location = ({ navigation, appTheme }) => {
    ...
    function renderHeader() {
        return (
            <SafeAreaView
                style={{
                    height: Platform.OS === 'android' ? 90 : SIZES.height > 700 ? 120 : 100,
                ...
                renderItem={({ item }) => (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Text style={{ color: appTheme.textColor, ...FONTS.body3 }}>Delivery</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                )}
        ...
        <View style={styles.container}>
            ...
            <View
                style={{
                    ...
                    padding: Platform.OS === 'ios' ? SIZES.padding : 18
                }}
            >
                {renderTopBarSection()}
                {renderSearchBar()}
